...
import { ModelReadonlyBadge } from "./input/model-readonly-badge";
import type {
  QuestionAnswer,
  QuestionConfig,
...
export type InputBarProps = {
  ...
  /** Read-only model label shown in the input toolbar. */
  modelBadge?: string;
      ...
      <div className="mx-auto max-w-an">
        ...
        >
          ...
          >
            ...
            <div className="pt-3 pb-0 pr-3 pl-3.5 min-h-[52px]">
              {isTyping ? (
            ...
            <div className="flex items-center justify-between gap-3 px-2 pt-1 pb-2">
              <div className="flex min-w-0 items-center gap-1">
                ...
                {modelBadge ? <ModelReadonlyBadge label={modelBadge} /> : null}
                {leftActions}
              </div>
          ...
          {suggestionItems.length > 0 && (
            <Suggestions
              ...
              className={cn("mt-3 justify-center px-1", suggestionsClassName)}
